...
export default function Projects () {
    return (
        ...
        <div className="project-section"> 
          ...
          <a href="https://www.shecodes.io/workshops/shecodes-basics-275631ab-9840-4885-a6a8-5afa8911fe76/projects/434164" className="btn btn-project mb-3">see project</a>
